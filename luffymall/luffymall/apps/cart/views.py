...
from luffymall import settings
...
class CartAPIview(ViewSet):
    ...
    def add(self, request):
        ...
        try:
            ...
            return Response({'message': '参数错误！课程不存在'}, status=status.HTTP_400_BAD_REQUEST)
    ...
    def list(self, request):
        ...
        for course_id_bytes, expire_id_bytes in cart_bytes_dict.items():
            ...
            data.append({
                ...
                "price": course.real_price(expire_id=expire_id),
            })
    ...
    def change_expire(self, request):
        ...
        real_price = course.real_price(expire_id=expire_id)
